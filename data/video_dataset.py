...
class VideoDataset(BaseDataset):
    ...
    def __init__(
        ...
        if self.opt.isTrain:
            self.vide_names_json = os.path.join(opt.data_root, opt.video_names_json)
            self.video_dir = os.path.join(opt.data_root, opt.video_dir)
            self.landmark_dir = os.path.join(opt.data_root, opt.landmark_dir)
        else:
            self.vide_names_json = os.path.join(opt.data_root, opt.video_names_json_val)
            self.video_dir = os.path.join(opt.data_root, opt.video_dir_val)
            self.landmark_dir = os.path.join(opt.data_root, opt.landmark_dir_val)
